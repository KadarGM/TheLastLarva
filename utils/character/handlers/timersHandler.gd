...
func setup_timers() -> void:
	...
	hide_weapon_timer.timeout.connect(character_manager._on_hide_weapon_timer_timeout)
	...
	damage_timer.timeout.connect(character_manager._on_damage_timer_timeout)
